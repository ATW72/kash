...
6. **Email Notifications:** A background scheduler (APScheduler) that sends customized email alerts over SMTP: 7-day bill warnings, budget limit warnings (80% and 100%), and a neat summary on the 1st of every month.
